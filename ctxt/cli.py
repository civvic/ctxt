"""Command-line interface for ctxt"""
...
def init(
    ...
    try:
        ...
        print("\nNext steps:")
        print("  1. Edit .ctxt.yml to customize tags")
        print("  2. Create templates/ directory structure")
        print("  3. Run 'ctxt build' to process templates")
        return 0
...
def tags(
    ...
    if path:
        ...
        if target.is_file():
            from ctxt.tags import discover_tags_in_file
